...
<head>
    ...
    <title>Riwayat Jurnal Siswa | {{ $nama }}</title>
                ...
                <div class="modal-body p-4">
                    <div class="jurnal-detail-card">
                        ...
                        <div class="info-section mb-4">
                            <h6 class="fw-bold text-dark mb-2">Materi yang Didapatkan</h6>
                            <div class="content-box" id="modal-materi"></div>
                        </div>

                        <div class="info-section mb-4">
                            <h6 class="fw-bold text-dark mb-2">Tugas Dari Pembimbing</h6>
                            <div class="content-box" id="modal-tugas"></div>
                        </div>

                        <div class="photo-section">
                            <h6 class="fw-bold text-dark mb-3">Foto Kegiatan</h6>
        ...
        <div class="container custom-container">
            <div class="page-header d-flex align-items-center mb-4">
                ...
                <div class="header-text">
                    <h3 class="fw-bold m-0 text-dark">Riwayat Jurnal Siswa</h3>
                    <p class="text-muted m-0 small">{{ $nama }} &bull; {{ $jurusan }}</p>
                </div>
            </div>
                    ...
                    <table class="table align-middle mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                {{-- kalau mau bulan jadi nama bulannya --}}
                            ...
                            @empty
                            <tr>
                                <td colspan="3" class="text-center py-5 text-muted italic font-sm">Belum ada catatan jurnal.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
                ...
                fetch(`/admin/jurnal/${id}`)
                    ...
                    .then(data => {
                        ...
                        if (data.foto_kegiatan) {
                            ...
                            photoContainer.innerHTML = `<div class="p-4 bg-light rounded text-muted">Tidak ada foto dilampirkan</div>`;
                        }
